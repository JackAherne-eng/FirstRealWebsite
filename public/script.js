...
function likeIt() {
  alert("Thank you for your feedback! Turns out we like you too ;)");
}
...
function welcomeUser() {
  ...
  document.getElementById("welcomeuser").innerHTML =
    "<p> Hello, " +
    username +
    ", looking forward to hearing your Anime Lists! Click this message to close it.</p>";
...
$(".reverse.images .image").transition({
  animation: "pulse",
  reverse: true,
  interval: 200
});
